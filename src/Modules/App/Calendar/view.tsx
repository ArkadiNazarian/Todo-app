import { Box, Button, FormControl, FormGroup, InputLabel, MenuItem, Modal, Paper, Select, TextField, Typography } from "@mui/material";
...
export const View = (props: IFormModel) => (
  <Box sx={{ minWidth: 1000 }}>
    <FullCalendar
      ...
      events={props.task_list}
      height={600}
      eventClick={(e) => props.handler_open_task_modal(e.event._def.publicId)}
      editable={true}
      droppable={true}
    ...
    <Modal open={props.open_task_modal} onClose={() => props.handler_close_task_modal()}>
      <Box sx={{ position: "absolute", top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: 800, minHeight: "60%", borderRadius: 2, boxShadow: 24, p: 4, background: "#ffffff" }}>
        <Box sx={{ borderBottom: 1, paddingBottom: 2, borderColor: "#00000033", display: "flex", justifyContent: "space-between" }} >
          <Typography fontSize={15} color="#00000099" sx={{ display: "flex", alignItems: "center", }}><CalendarMonthOutlinedIcon sx={{ color: "#058527", marginRight: "8px", fontSize: 20 }} />Task</Typography>
