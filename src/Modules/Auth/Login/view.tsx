...
export const View = (props: IFormModel) => (
    <Box sx={{ height: "100vh", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", background: "#03c2fc" }}>
        <Box sx={{ boxShadow: 6, padding: 4, background: "#ffffff", borderRadius: 3 }}>
            ...
            <Typography variant="h6" sx={{ color: "#1976d2" }}>Don't have an account?<Link to={props.path.signup}>Sign up</Link></Typography>
            <Typography variant="h6" sx={{ color: "#1976d2" }}><Link to={props.path.forgot_password}>Forgot your password?</Link></Typography>
        </Box>
    </Box>
)